...
import { LargeSidebarItem, LargeSidebarSection, SmallSidebarItem } from "../components/sidebar";
...
export const Sidebar = () => {
  ...
  return (
    <>
      ...
      >
        <div className="lg:hidden pt-2 pb-4 px-2 stiky top-0 bg-white">
        ...
        <LargeSidebarSection title="Subscriptions" visibleItemCount={5}>
          {subscriptions.map(({ id, channelName, imgUrl }) => (
            <LargeSidebarItem IconOrImgUrl={imgUrl} title={channelName} url={`/@${id}`} />
          ))}
        </LargeSidebarSection>
